  ...
  handler: function (request, reply) {
    let list = [
      ...
      [{
        ...
        name: 'Christopher Clint'
      }],
      [{
        name: 'Baxter Windsor'
      }, {
        name: 'Windsor Clinton'
      }],
      [{
        name: 'Kurtis Barnaby Reginald'
      }, {
        name: 'Nevil James Baz'
      }],
      [{
        name: 'Bud Jemmy Paulie'
      }, {
        name: 'Julian Nigellus Devin'
      }],
    ]
